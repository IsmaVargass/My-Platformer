<%-- // // DefaultWsdlHelpGenerator.aspx: // // Author: // Ismael Vargas Duque // // (C) 2003 Ximian, Inc.
	http://www.ximian.com // --%>
	...
	protected override string GetLiteral(string s)
		...
		XmlQualifiedName GetContentBaseType(XmlSchemaObject ob)
			...
			XmlAttribute xat = null;
																												...
																												if (at.LocalName == "arrayType" && at.NamespaceURI == WsdlNamespace) { xat = at; break; }
																										...
																										<table
																											...
																											<tr
																												...
																												<td width="150px"
																													...
																													<a class="method"
																														href='<%=PageName%>'>Overview</a><br>
																													<div
																														class="smallSeparator">
																													</div>
																													<a class="method"
																														href='<%=PageName + "?" + GetPageContext("wsdl")%>'>Service
																														Description</a>
																													<div
																														class="smallSeparator">
																													</div>
																													<a class="method"
																														href='<%=PageName + "?" + GetPageContext("proxy")%>'>Client
																														proxy</a>
																													<br><br>
																													<asp:repeater
																														id="BindingsRepeater"
																														...
																														<itemtemplate
																															...
																															<span
																																class="bindingLabel">
																																<%#FormatBindingName(DataBinder.Eval(Container.DataItem, "Name"
																																	).ToString())%>
																															</span>
																															<asp:repeater
																																id="OperationsRepeater"
																																runat=server
																																datasource='<%# ((Binding)Container.DataItem).Operations %>'>
																																<itemtemplate>
																																	<a class="method"
																																		href="<%=PageName%>?<%=GetTabContext("
																																		op",null)%>op=
																																		<%#GetOpName(Container.DataItem)%>
																																			&bnd=
																																			<%#DataBinder.Eval(Container.DataItem, "Binding.Name"
																																				)%>
																																				">
																																				<%#GetOpName(Container.DataItem)%>
																																					</a>
																																														...
																																														<% if
																																															...
																																															<form
																																																...
																																																<input
																																																	type="hidden"
																																																	name="bnd"
																																																	value="<%=CurrentOperationBinding%>">
																																																<input
																																																	type="hidden"
																																																	name="ext"
																																																	value="testform">
																																																<table
																																																	class="paramFormTable"
																																																	cellspacing="0"
																																																	cellpadding="3">
																																																	<asp:repeater
																																																		id="InputFormParamsRepeater"
																																																		runat=server>
																																																		<itemtemplate>
																																																			<tr>
																																																				<td>
																																															...
																																															<div id="testFormResult"
																																																style="display:<%= (HasFormResult?"
																																																block":"none")
																																																%>
																																																">
																																																The
...
-->
																																																		...
																																																		<% if
																																																			...
																																																			<% if
																																																				...
																																																				%>
																																																				<span
																																																					class="label">Soap</span>
																																																				<br /><br />
																																																				<div
																																																					class="codePanel">
																																																					<div
																																																						class="code-xml">
																																																						<%=GenerateOperationMessages
																																																							("Soap",
																																																							true)%>
																																																					</div>
																																																				</div>
...
-->
																																																											<form
																																																												...
																																																												<SELECT
																																																													name="lang"
																																																													onchange="langForm.submit()">
																																																													<%=GetOptionSel("cs",CurrentLanguage)%>
																																																														C#
																																																														</option>
																																																														<%=GetOptionSel("vb",CurrentLanguage)%>
																																																															Visual
																																																															Basic
																																																															</option>
																																																												</SELECT>
																																																											...
																																																											<a href="<%=PageName + "
																																																												?code=" + CurrentLanguage%>">Download</a>
																																																											<br><br>
																																																											<div
																																																												class="codePanel">
																																																												<div
																																																													class="code-<%=CurrentLanguage%>">
																																																													<%=GetProxyCode
																																																														()%>
																																																												</div>
																																																											</div>
																																																												...
																																																												<% if
																																																													...
																																																													<ul>
																																																														<% for
																																																															...
																																																															("<li>
																																																															<a
																																																																href='" + PageName + "?" + GetPageContext(null) + "doctype=wsdl&docind=" + n + "'>WSDL
																																																																document
																																																																"
																																																																+
																																																																descriptions[n].TargetNamespace
																																																																+
																																																																"</a>
																																																															</li>
																																																															");
																																																															...
																																																															<schemas.Count;
																																																																...
																																																																("<li>
																																																																<a
																																																																	href='" + PageName + "?" + GetPageContext(null) + "doctype=schema&docind=" + n + "'>Xml
																																																																	Schema
																																																																	"
																																																																	+
																																																																	schemas[n].TargetNamespace
																																																																	+
																																																																	"</a>
																																																																</li>
																																																																");
